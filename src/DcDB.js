...
function DcDB(){
    ...
    // Only characters registered in the DC Universe
    db.exec('CREATE TABLE fictionalUniverse')
    db.exec('INSERT INTO fictionalUniverse SELECT char FROM ? WHERE fictionalUniverseLabel LIKE "DC Universe"', [fictionalUniverse])
